(function(exports){
    ...
    var OTDCPWAssetSearchManager = exports.OTDCPWAssetSearchManager = function OTDCPWAssetSearchManager(){};

    var searchResultsFacetsQue = [];
    var searchResultFacets = [];

    OTDCPWAssetSearchManager.getFolderAssetsByKeyword = function getFolderAssetsByKeyword(filterTerm, pageNumber, pageSize, preferenceID, extraFields, data, callback)
	{
		...
		otui.post(serviceUrl, params.join("&"), otui.contentTypes.formData, function(response, status, success)
        {
			...
			else
			{
				...
				// {
				// 	var pwResultsView = otui.main.getChildView(OTDCPWHomeView);
    ...
    OTDCPWAssetSearchManager.clearSearchForKeyword = function(keyword)
    {
    	searchResultFacets[keyword] = null;
    };

    OTDCPWAssetSearchManager.getSearchResultFacetsByKeyword = function(keyword, callback)
    {
